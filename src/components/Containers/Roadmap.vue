<template>
  <div class="changelog box">
    ...
    <div class="log">
      ...
      <p>
        Significant improvements to the loading speed of the app in general, but
        especially with the Link Opportunities feature.
      </p>
...
.changelog {
  ...
  position: relative;
  animation: bpprimary 30s infinite alternate-reverse;
  h1 {
    font-size: $big;
    font-weight: 300;
