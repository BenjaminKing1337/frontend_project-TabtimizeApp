<template>
    <div class="changelog box">
        ...
        <div class="log">
            ...
            <h1>Better sign up flow</h1>
            <p>A much cleaner and simpler sign up flow which makes it easy for you to create an account without having to verify with a Google Search Console account</p>
